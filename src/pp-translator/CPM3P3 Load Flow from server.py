...
async def main():
    ...
    async with connect_async(host=args.server, rpc_port=args.rpc_port) as channel:
        ...
        geo_results = geopandas.GeoDataFrame(term_resultsX,crs="EPSG:4326",geometry=geopandas.points_from_xy(term_resultsX.x, term_resultsX.y))
        ...
        for idx in term_resultsX.index:
            term_resultsX.at[idx,'SvVoltage']= {"angle":term_resultsX.at[idx,'va_degree'],"v":term_resultsX.at[idx,'vn_kv'],"TopologicalNode_mRID":term_resultsX.at[idx,'TopologicalNode_mRID']}
            term_resultsX.at[idx,'SvPowerFlow']={"p":term_resultsX.at[idx,'p'],"q":term_resultsX.at[idx,'q'],"ConductingEquipment_mRID":term_resultsX.at[idx,'ConductingEquipment_mRID']}
        term_resultsX=term_resultsX.drop(['name_x','va_degree','vn_kv','TopologicalNode_mRID','ConductingEquipment_mRID','p','q','name_y','p_mw','q_mvar','x','y'],axis=1)
